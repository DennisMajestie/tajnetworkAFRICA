...
@Component({
        ...
        <div class="contact-layout">
          ...
          <div class="form-container">
            <div class="crystalline-container">
              ...
              <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="crystalline-form" *ngIf="!showSuccess">
                <div class="form-grid">
                  <div class="input-group">
                    <label>Full Name</label>
                    <div class="input-wrapper">
                      <input type="text" formControlName="name" placeholder="E.g. Alexander Taj">
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-wrapper">
                      <input type="text" formControlName="phone" placeholder="+234 ...">
                      <div class="input-glow"></div>
                    </div>
                  </div>
                  ...
                  <div class="input-group">
                    ...
                    <div class="input-wrapper select-wrapper">
                      <select formControlName="department" class="taj-select">
                        <option value="" disabled selected>What are we building?</option>
                        <option value="development">Software Engineering</option>
                        <option value="consulting">IT Strategy & Audits</option>
              ...
              <!-- Success State -->
              <div class="form-feedback active" *ngIf="showSuccess">
                <div class="feedback-card">
                  <div class="success-icon">
                    <i class="fas fa-check-double"></i>
                  </div>
                  <div class="success-content">
                    <span class="success-tag">Transmission Successful</span>
                    <h3 class="success-title">Brief Received.</h3>
                    <p class="success-desc">
                      Our lead engineers are already reviewing your vision. Expect a strategic response in your inbox within 120 minutes.
                    </p>
                  </div>
                  <button (click)="showSuccess = false" class="btn-success-return">Send Another Inquiry</button>
                </div>
              </div>
            </div>
          </div>
  ...
  styles: [`
    ...
    .orb-2 { width: 500px; height: 500px; background: radial-gradient(circle, rgba(0, 208, 132, 0.1) 0%, transparent 70%); bottom: -150px; left: -100px; animation-delay: -10s; }
    ...
    .grid-overlay {
      ...
      background-image: linear-gradient(rgba(0, 102, 255, 0.02) 1px, transparent 1px), linear-gradient(90deg, rgba(0, 102, 255, 0.02) 1px, transparent 1px);
    ...
    .sidebar-badge {
      display: inline-flex; align-items: center; gap: 10px; padding: 10px 20px; background: rgba(0, 208, 132, 0.1); border: 1px solid rgba(0, 208, 132, 0.2); border-radius: 100px; margin-bottom: 30px;
      i { color: var(--color-accent-emerald); font-size: 0.9rem; }
      span { color: var(--color-accent-emerald); font-size: 0.75rem; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; }
    }

    .sidebar-title { font-size: 2.2rem; font-weight: 900; color: #fff; line-height: 1.2; margin-bottom: 40px; .highlight { display: block; color: var(--color-accent-blue); } }
    ...
    .benefit-content { h4 { font-size: 1.1rem; font-weight: 800; color: #fff; margin: 0 0 5px; } p { font-size: 0.9rem; color: rgba(255, 255, 255, 0.5); margin: 0; line-height: 1.4; } }
    ...
    .form-title { font-size: clamp(1.8rem, 4vw, 2.8rem); font-weight: 900; color: #fff; letter-spacing: -0.03em; margin-bottom: 12px; .highlight { background: linear-gradient(135deg, var(--color-accent-blue), var(--color-accent-emerald)); -webkit-background-clip: text; -webkit-text-fill-color: transparent; } }
    ...
    .terms-note { display: flex; align-items: center; gap: 10px; font-size: 0.9rem; color: rgba(255, 255, 255, 0.7); i { color: var(--color-accent-emerald); font-size: 1rem; } }
    ...
    .success-icon { width: 80px; height: 80px; background: rgba(0, 208, 132, 0.1); border: 1px solid var(--color-accent-emerald); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 2.5rem; color: var(--color-accent-emerald); margin-bottom: 30px; }
    ...
    .btn-success-return { padding: 18px 35px; background: var(--color-accent-emerald); color: #fff; border: none; border-radius: 100px; font-weight: 800; cursor: pointer; transition: all 0.3s ease; &:hover { transform: translateY(-3px); box-shadow: 0 10px 25px rgba(0, 208, 132, 0.3); } }
    ...
    :host-context(.theme-light) {
      ...
      .form-subtitle, .success-desc, .benefit-content p, .input-group label { color: #64748b; }
